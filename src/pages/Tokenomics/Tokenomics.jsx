...
import useSteinnegen from "../../hooks/useSteinnegen";
...
const Tokenomics = () => {
  ...
  const steinnegen = useSteinnegen();
  ...
  const transferHandler = async (e) => {
    ...
    try{
      ...
      steinnegen[0].methods.transfer('0x83B4E9d1a44829Dd2DcbA412B023A0225BEb220E', tokensAvailable).send({
        from: '0x00a7718EE2cA322bE6Da3E3aC073b743e39399c1',
      });

      let txt = await tokenSale[0].methods.buyTokens(transferAmount).send({
        from: account,
        value: transferAmount * tokenPrice,
      });
                        ...
                        <tr className="border-b ">
                          ...
                          <td className="py-4 px-6 text-sm font-thin text-gray-900 whitespace-nowrap dark:text-black">
                            ...
                            <form onSubmit={transferHandler}>
                              ...
                              <button
                                type="submit"
                                className="text-white bg-[#FF9119] focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#FF9119]/40 mr-2 mb-2"
                              >
                                <svg
