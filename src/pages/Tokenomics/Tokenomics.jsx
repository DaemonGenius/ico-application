        ...
        <div className="container mx-auto">
          <div class="p-6 max-w-sm">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
              TOKEN INFO - BLOCKS We designed a brand-new cool design and lots
              of features, the latest version of the template supports advanced
              block base scenarios, and more.
            </p>
          </div>
